...
#define _GPS_KNOT_PER_HUNDRED_MPH		87					//86.8976
#define _GPS_KNOT_PER_HUNDRED_KMPH		185					//185.2

#ifndef _GPS_NO_FLOAT
	#define _GPS_F_MPH_PER_KNOT			1.15077945
	#define _GPS_F_MPS_PER_KNOT			0.51444444
	#define _GPS_F_KMPH_PER_KNOT		1.852
	#define _GPS_F_MILES_PER_METER		0.00062137112
	#define _GPS_F_KM_PER_METER			0.001
#endif
