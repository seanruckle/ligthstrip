...
byte TinyGPS::speed_mph()
{
	return _speed == GPS_INVALID_SPEED ? GPS_INVALID_SPEED :  _speed / _GPS_KNOT_PER_HUNDRED_MPH;
}



byte TinyGPS::speed_kmph()
{
	return _speed == GPS_INVALID_SPEED ? GPS_INVALID_SPEED : _speed / _GPS_KNOT_PER_HUNDRED_KMPH;
}
...
{ 
  ...
  return sk == GPS_INVALID_F_SPEED ? GPS_INVALID_F_SPEED : _GPS_F_MPH_PER_KNOT * sk; 
}

float TinyGPS::f_speed_mps()   
{ 
  float sk = f_speed_knots();
  return sk == GPS_INVALID_F_SPEED ? GPS_INVALID_F_SPEED : _GPS_F_MPS_PER_KNOT * sk; 
}

float TinyGPS::f_speed_kmph()  
{ 
  float sk = f_speed_knots();
  return sk == GPS_INVALID_F_SPEED ? GPS_INVALID_F_SPEED : _GPS_F_KMPH_PER_KNOT * sk; 
}
